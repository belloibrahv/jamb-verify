          ...
          <div className="flex items-start justify-between gap-6">
            ...
            <div className="hidden print:flex flex-col gap-2 text-right">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-green-100 border border-green-300">
                ...
                <span className="text-xs font-semibold text-green-900">JAMB Compliant</span>
              </div>
        ...
        <div className="p-8 print:p-12">
          ...
          <div className="mt-8 border-t border-border/70 pt-6 print:mt-12">
            <div className="text-center mb-4">
              ...
              <p className="text-sm font-bold text-primary">JAMB Verify</p>
              <p className="text-xs text-muted-foreground">
                Authorized NIN Verification Service for JAMB Registration
              </p>
            </div>
            
            <div className="flex items-center justify-center gap-8 mb-4 text-xs text-muted-foreground">
              <div className="text-center">
                <p className="font-semibold text-green-700">JAMB</p>
                <p className="text-[10px]">Compliant Service</p>
              </div>
