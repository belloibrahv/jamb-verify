      ...
      <div className="space-y-10">
        ...
        <div className="grid gap-6 lg:grid-cols-[1.4fr_0.8fr]">
          <section className="rounded-3xl border border-border/60 bg-white/80 p-6 shadow-card">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              We collect only the data needed to verify NINs, process wallet payments,
              and provide receipts. Full NIN values are never stored in our database;
              we store masked NINs and the verification outcome instead.
            </p>
            <ul className="mt-4 list-disc space-y-2 pl-5 text-sm text-muted-foreground">
              <li>Identity verification is performed via authorized third parties.</li>
              <li>
                We require explicit consent before any NIN verification request is sent.
              </li>
              <li>
                Transaction records are retained to support refunds, receipts, and audits.
              </li>
            </ul>
          </section>
          ...
          <aside className="rounded-3xl border border-border/60 bg-white/80 p-6 shadow-card">
            ...
            <div className="mt-4 space-y-2 text-sm text-muted-foreground">
              ...
              <p>
                <span className="font-semibold text-foreground">Address:</span> Lagos,
                Nigeria
              </p>
            </div>
          </aside>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <section className="rounded-3xl border border-border/60 bg-white/80 p-6 shadow-card">
            ...
            <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-muted-foreground">
              ...
              <li>
                Verification data: masked NIN, consent flag, verification status, and
                returned identity fields such as name, date of birth, and phone number.
              </li>
              <li>
                Transaction data: wallet balance, funding references, amounts, and
                refund records.
              </li>
              <li>
                Technical data: device identifiers, IP address, browser type, and
                log data required for security and fraud prevention.
              </li>
          ...
          <section className="rounded-3xl border border-border/60 bg-white/80 p-6 shadow-card">
            ...
            <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-muted-foreground">
              <li>Consent: required before any NIN verification is performed.</li>
              <li>Contract: to deliver verification, wallet, and receipt services.</li>
              <li>Legal obligation: to meet accounting, tax, and regulatory duties.</li>
              <li>
                Legitimate interests: service security, fraud prevention, and quality
                assurance.
              </li>
            </ul>
          </section>
          ...
          <section className="rounded-3xl border border-border/60 bg-white/80 p-6 shadow-card">
            ...
            <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-muted-foreground">
              <li>
                Verification partners (e.g., YouVerify) to confirm NIN details with NIMC
                systems.
              </li>
              <li>Payment processors (e.g., Paystack) for wallet funding and refunds.</li>
          ...
          <section className="rounded-3xl border border-border/60 bg-white/80 p-6 shadow-card">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              We retain data only for as long as needed to provide the service and meet
              legal obligations. Verification logs, transaction records, and receipts are
              kept for audit and dispute resolution. Raw verification responses are
              restricted and stored only when necessary for troubleshooting.
            </p>
          </section>
          ...
          <section className="rounded-3xl border border-border/60 bg-white/80 p-6 shadow-card">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              We apply industry-standard safeguards including encryption in transit,
              access controls, monitoring, and least-privilege access. No security
              measure is perfect, but we continuously improve our controls.
            </p>
          </section>
          ...
          <section className="rounded-3xl border border-border/60 bg-white/80 p-6 shadow-card">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              Some service providers may process data outside Nigeria. When this occurs,
              we apply appropriate safeguards and contractual protections.
            </p>
          </section>
          ...
          <section className="rounded-3xl border border-border/60 bg-white/80 p-6 shadow-card md:col-span-2">
            ...
            <p className="mt-4 text-sm text-muted-foreground">
              We will notify users of material updates to this policy. Continued use of
              the service after changes means you accept the revised policy.
            </p>
          </section>
        </div>
      </div>
